#
#  Be sure to run `pod spec lint XYWebImage.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "wuw"
  # s.authors            = { "wuw" => "fifyrio@qq.com" }
  # s.social_media_url   = "http://twitter.com/wuw"
  ...
  s.source_files  = "XYWebImage/Core/*.{h,m}","XYWebImage/UIKit/*.{h,m}"
